        ...
        <body class="gray-bg">
            <div class="wrapper wrapper-content animated fadeInRight">
                <div class="location  clearfix">
                    <p class="pull-left"><i class="fa fa-map-marker"></i> 项目管理 > 项目列表</p>
                    <p class="pull-right text-right"><i class="fa fa-home"></i> 项目管理 >项目列表 </p>
                </div>
                <!--location end-->
                            ...
                            <div class="col-sm-12 pr0 pl0">
                                <div class="tabs-container">
                                    <ul class="nav nav-tabs">
                                        <li class="active"><a data-toggle="tab" href="#tab-1" aria-expanded="true">2019年</a> </li>
                                        <li class=""><a data-toggle="tab" href="#tab-2" aria-expanded="false">2018年</a></li>
                                        <li class=""><a data-toggle="tab" href="#tab-2" aria-expanded="false">2017年</a></li>
                                    ...
                                    <div class="tab-content">
                                                ...
                                                <div class="ibox float-e-margins">
                                                    <div class="ibox-title">
                                                        ...
                                                        <div class="ibox-tools">
                                                            <!-- <a href="addProject.jsp" class="btn btn-success dropdown-toggle" href="javascript:void(0);" target="iframe0"> <i class="fa fa-file-o"></i> 添加 </a>
                                        ...
                                        String sql="select * from project order by proid desc";
                                                            ...
                                                            <table class="table table-hover row-border cell-border order-column dataTables-example dataTable table-condensed">
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th style="width: 329px;">项目编号</th>
                                                                        <th style="width: 329px;">项目名称</th>
                                                                        <th style="width: 329px;">部门经济科目</th>
                                                                        <th style="width: 329px;">单据日期</th>
                                                                        <th style="width: 329px;">摘要</th>
                                                                        <th style="width: 329px;">支出金额(单位/元)</th>
                                                                        <th style="width: 329px;">部门</th>
                                                                ...
                                                                <tbody>
                                                                    <% while(rs.next()){ %>
                                                                        <tr>
                                                                            ...
                                                                            <!-- <td>
                                                                <a href=editProject.jsp?proid="+intId+" class="btn btn-success btn-manage" title="修改"> <i class="fa fa-edit">修改</i> </a>
                                                                <a href="" class="btn btn-success btn-manage" title="删除"> <i class="fa fa-remove">删除</i> </a>
                                                            </td> -->
                                                                        </tr>
                                                                        <%
                                                }
