<%@page language="java" import="java.util.*" pageEncoding="UTF-8"%>
	...
	String sql1="update project set proname='"+strEditproname+"',economicSubjects='"+strEditeconomicSubjects+"',date='"+strEditdate+"',abstract='"+strEditabstract+"',expend='"+strEditexpend+"',department='"+strEditdepartment+"',approvalStatus='"+strEditapprovalStatus+"',time='"+formateOne.format(currentDay)+"' where proid='"+intOne+"'";

	stmt1.executeUpdate(sql1);	

	out.println("<script>window.alert('修改成功');location.replace('项目管理.jsp')</script>");		
