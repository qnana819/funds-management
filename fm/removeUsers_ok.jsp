<%@page language="java" import="java.util.*" pageEncoding="UTF-8"%>
	...
	String strEditproname=request.getParameter("edituserName");
	String strEditeconomicSubjects=request.getParameter("editpassWord");
	...
	String sql1="delete from user1 where id='"+intOne+"'";
	stmt1.executeUpdate(sql1);	

	out.println("<script>window.alert('删除成功！');location.replace('用户列表.jsp')</script>");		
