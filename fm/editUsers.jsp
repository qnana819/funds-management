...
%>
                                <form action="editUsers_ok.jsp" method="post">
                                        ...
                                        <div class="ibox-content clearfix pr0 search_box">
                                            <div class="col-md-6 col-md-offset-3">
                                                ...
                                                <div class="form-group clearfix">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" name="userName" class="form-control" placeholder="" value="<%=struserName%>">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group clearfix">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" name="passWord" class="form-control" placeholder="" value="<%=strpassWord%>">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
