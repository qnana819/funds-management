                    ...
                    <div class="row">
                        <div class="col-md-6 col-md-offset-3">
                            <%
                                    ...
                                    String sql="select * from approve where proid='"+intOne+"'";
                                ...
                                %>
                                <form action="removeProject_ok.jsp" method="post">
                                            ...
                                            <div class="col-md-10 col-md-offset-1">
                                               ...
                                               <option value="其他">其他</option>
                                                ...
                                                <div class="form-group clearfix">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select type="text" name="editdepartment" class="form-control" placeholder="" value="<%=strdepartment%>">
                                               <!-- <option value="0">请选择---</option>  -->
                                               ...
                                               <option value="物流">物流</option> 
                                                ...
                                                <div class="form-group clearfix">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select type="text" name="editapprovalStatus" class="form-control" placeholder="">
                                                       <!-- <option value="0">请选择---</option>  -->
