<%@page language="java" import="java.util.*" pageEncoding="UTF-8"%>
                                                ...
                                                <div class="ibox float-e-margins">
                                                    <div class="ibox-title">
                                                        ...
                                                        <div class="ibox-tools">
                                                            <a href="addApprove.jsp" class="btn btn-success dropdown-toggle" href="javascript:void(0);" target="iframe0"> <i class="fa fa-file-o"></i> 添加 </a>
	...
	String sql="select * from approve order by proid desc";
                                                        ...
                                                        <div class="ibox-content clearfix">
                                                            <table class="table table-hover row-border cell-border order-column dataTables-example dataTable table-condensed">
                                                                ...
                                                                <%int intId=rs.getInt("proid");
                                                                    out.print("<a href=editApprove.jsp?proid="+intId+">");
                                                                %>
                                                                <i class="fa fa-edit">修改</i> </a>
                                                                    ...
                                                                    out.print("<a href=removeApprove.jsp?proid="+removeId+">");
                                                                %>
